...
df.lic3 <- read.csv("Unit_cost_LIC_select_0311.csv")
df.lic3$target <- 0.8

df.lmic <- read.csv("Unit_cost_LMIC_select_0311.csv")
df.lmic$target <- 0.8
...
lic <- read_xlsx("LGH Costing_20200324.xlsx", sheet = "LIC Input")
lmic <- read_xlsx("LGH Costing_20200324.xlsx", sheet = "LMIC Input")
more.info <- read_xlsx("LGH Costing_20200324.xlsx", sheet = "More info")

result_table_article <- read.csv("Result_0311.csv")
